        ...
        <div className="sticky top-0 flex h-screen flex-col items-center justify-center overflow-hidden px-6">
          ...
          >
            <img
              ...
              alt="Magnovite"
              className="mb-6 h-16 w-auto sm:h-24"
            />
            <h1 className="font-display text-[13vw] leading-[0.85] font-semibold tracking-[0.06em] sm:text-[9vw] text-white">
              MAGNOVITE
            </h1>
            <p className="mt-4 text-[0.9rem] tracking-[1.1em] text-white/70 sm:text-lg">2026</p>
          </div>
