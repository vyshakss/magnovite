...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function As(e,t,n){let r=new Float32Array(gs),i=new G(0,1,0);return new Aa({name:`SphericalGaussianBlur`,defines:{n:gs,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Ns(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function js(){return new Aa({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Ns(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ms(){return new Aa({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ns(),fragmentShader:`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
		...
		}`},Md=class e extends Sd{constructor(e,t=1,n,r){super(),this.strength=t,this.radius=n,this.threshold=r,this.resolution=e===void 0?new W(256,256):new W(e.x,e.y),this.clearColor=new Y(0,0,0),this.needsSwap=!1,this.renderTargetsHorizontal=[],this.renderTargetsVertical=[],this.nMips=5;let i=Math.round(this.resolution.x/2),a=Math.round(this.resolution.y/2);this.renderTargetBright=new cn(i,a,{type:M}),this.renderTargetBright.texture.name=`UnrealBloomPass.bright`,this.renderTargetBright.texture.generateMipmaps=!1;for(let e=0;e<this.nMips;e++){let t=new cn(i,a,{type:M});t.texture.name=`UnrealBloomPass.h`+e,t.texture.generateMipmaps=!1,this.renderTargetsHorizontal.push(t);let n=new cn(i,a,{type:M});n.texture.name=`UnrealBloomPass.v`+e,n.texture.generateMipmaps=!1,this.renderTargetsVertical.push(n),i=Math.round(i/2),a=Math.round(a/2)}let o=jd;this.highPassUniforms=Da.clone(o.uniforms),this.highPassUniforms.luminosityThreshold.value=r,this.highPassUniforms.smoothWidth.value=.01,this.materialHighPassFilter=new Aa({uniforms:this.highPassUniforms,vertexShader:o.vertexShader,fragmentShader:o.fragmentShader}),this.separableBlurMaterials=[];let s=[6,10,14,18,22];i=Math.round(this.resolution.x/2),a=Math.round(this.resolution.y/2);for(let e=0;e<this.nMips;e++)this.separableBlurMaterials.push(this._getSeparableBlurMaterial(s[e])),this.separableBlurMaterials[e].uniforms.invSize.value=new W(1/i,1/a),i=Math.round(i/2),a=Math.round(a/2);this.compositeMaterial=this._getCompositeMaterial(this.nMips),this.compositeMaterial.uniforms.blurTexture1.value=this.renderTargetsVertical[0].texture,this.compositeMaterial.uniforms.blurTexture2.value=this.renderTargetsVertical[1].texture,this.compositeMaterial.uniforms.blurTexture3.value=this.renderTargetsVertical[2].texture,this.compositeMaterial.uniforms.blurTexture4.value=this.renderTargetsVertical[3].texture,this.compositeMaterial.uniforms.blurTexture5.value=this.renderTargetsVertical[4].texture,this.compositeMaterial.uniforms.bloomStrength.value=t,this.compositeMaterial.uniforms.bloomRadius.value=.1;let c=[1,.8,.6,.4,.2];this.compositeMaterial.uniforms.bloomFactors.value=c,this.bloomTintColors=[new G(1,1,1),new G(1,1,1),new G(1,1,1),new G(1,1,1),new G(1,1,1)],this.compositeMaterial.uniforms.bloomTintColors.value=this.bloomTintColors,this.copyUniforms=Da.clone(xd.uniforms),this.blendMaterial=new Aa({uniforms:this.copyUniforms,vertexShader:xd.vertexShader,fragmentShader:xd.fragmentShader,premultipliedAlpha:!0,blending:2,depthTest:!1,depthWrite:!1,transparent:!0}),this._oldClearColor=new Y,this._oldClearAlpha=1,this._basic=new ti,this._fsQuad=new Td(null)}dispose(){for(let e=0;e<this.renderTargetsHorizontal.length;e++)this.renderTargetsHorizontal[e].dispose();for(let e=0;e<this.renderTargetsVertical.length;e++)this.renderTargetsVertical[e].dispose();this.renderTargetBright.dispose();for(let e=0;e<this.separableBlurMaterials.length;e++)this.separableBlurMaterials[e].dispose();this.compositeMaterial.dispose(),this.blendMaterial.dispose(),this._basic.dispose(),this._fsQuad.dispose()}setSize(e,t){let n=Math.round(e/2),r=Math.round(t/2);this.renderTargetBright.setSize(n,r);for(let e=0;e<this.nMips;e++)this.renderTargetsHorizontal[e].setSize(n,r),this.renderTargetsVertical[e].setSize(n,r),this.separableBlurMaterials[e].uniforms.invSize.value=new W(1/n,1/r),n=Math.round(n/2),r=Math.round(r/2)}render(t,n,r,i,a){t.getClearColor(this._oldClearColor),this._oldClearAlpha=t.getClearAlpha();let o=t.autoClear;t.autoClear=!1,t.setClearColor(this.clearColor,0),a&&t.state.buffers.stencil.setTest(!1),this.renderToScreen&&(this._fsQuad.material=this._basic,this._basic.map=r.texture,t.setRenderTarget(null),t.clear(),this._fsQuad.render(t)),this.highPassUniforms.tDiffuse.value=r.texture,this.highPassUniforms.luminosityThreshold.value=this.threshold,this._fsQuad.material=this.materialHighPassFilter,t.setRenderTarget(this.renderTargetBright),t.clear(),this._fsQuad.render(t);let s=this.renderTargetBright;for(let n=0;n<this.nMips;n++)this._fsQuad.material=this.separableBlurMaterials[n],this.separableBlurMaterials[n].uniforms.colorTexture.value=s.texture,this.separableBlurMaterials[n].uniforms.direction.value=e.BlurDirectionX,t.setRenderTarget(this.renderTargetsHorizontal[n]),t.clear(),this._fsQuad.render(t),this.separableBlurMaterials[n].uniforms.colorTexture.value=this.renderTargetsHorizontal[n].texture,this.separableBlurMaterials[n].uniforms.direction.value=e.BlurDirectionY,t.setRenderTarget(this.renderTargetsVertical[n]),t.clear(),this._fsQuad.render(t),s=this.renderTargetsVertical[n];this._fsQuad.material=this.compositeMaterial,this.compositeMaterial.uniforms.bloomStrength.value=this.strength,this.compositeMaterial.uniforms.bloomRadius.value=this.radius,this.compositeMaterial.uniforms.bloomTintColors.value=this.bloomTintColors,t.setRenderTarget(this.renderTargetsHorizontal[0]),t.clear(),this._fsQuad.render(t),this._fsQuad.material=this.blendMaterial,this.copyUniforms.tDiffuse.value=this.renderTargetsHorizontal[0].texture,a&&t.state.buffers.stencil.setTest(!0),this.renderToScreen?(t.setRenderTarget(null),this._fsQuad.render(t)):(t.setRenderTarget(r),this._fsQuad.render(t)),t.setClearColor(this._oldClearColor,this._oldClearAlpha),t.autoClear=o}_getSeparableBlurMaterial(e){let t=[],n=e/3;for(let r=0;r<e;r++)t.push(.39894*Math.exp(-.5*r*r/(n*n))/n);return new Aa({defines:{KERNEL_RADIUS:e},uniforms:{colorTexture:{value:null},invSize:{value:new W(.5,.5)},direction:{value:new W(.5,.5)},gaussianCoefficients:{value:t}},vertexShader:`
				...
				}`})}};Md.BlurDirectionX=new W(1,0),Md.BlurDirectionY=new W(0,1);var Nd=`
varying vec2 vUv;
...
`,Id=n(u(),1);function Ld(){let e=document.createElement(`canvas`);e.width=64,e.height=64;let t=e.getContext(`2d`);return t.beginPath(),t.arc(32,32,31,0,Math.PI*2),t.fillStyle=`#ffffff`,t.fill(),new ga(e)}var Rd=[{angle:0,radius:6.5,height:1.2},{angle:Math.PI*1,radius:4.2,height:.5},{angle:Math.PI*1.8,radius:2.2,height:.15},{angle:Math.PI*2.5,radius:2.6,height:-.2},{angle:Math.PI*3.2,radius:2.8,height:.4},{angle:Math.PI*3.9,radius:2.5,height:.6},{angle:Math.PI*4.6,radius:2.3,height:-.3},{angle:Math.PI*5.2,radius:2,height:.1}];function zd(e){return e=Math.max(0,Math.min(1,e)),e*e*e*(e*(e*6-15)+10)}function Bd(e){let t=(0,Id.useRef)(!1);(0,Id.useEffect)(()=>{let n=e.current;if(!n||t.current)return;t.current=!0;let r=new qn;r.background=new Y(263172),r.fog=new Kn(394758,.0075);let i=new To(55,window.innerWidth/window.innerHeight,.1,1e3),a=()=>window.innerWidth<=768||`ontouchstart`in window&&window.innerWidth<=1024,o=a(),s=new vu({antialias:!o,alpha:!1,powerPreference:`high-performance`});s.setSize(window.innerWidth,window.innerHeight),s.setPixelRatio(o?1:Math.min(window.devicePixelRatio,2)),s.outputColorSpace=$e,s.toneMapping=4,s.toneMappingExposure=.65,n.appendChild(s.domElement);let c=new kd(s),l=new Ad(r,i);c.addPass(l);let u=new Md(new W(window.innerWidth,window.innerHeight),.14,.35,.85);o||c.addPass(u);let d=new No(16777215,.22);r.add(d);let f=Ld(),p=.012,m=null,h={value:0},g={value:0},_={uIntensity:{value:0},uCore:{value:1}},v=new pi(new xa(1,1),new Aa({uniforms:_,vertexShader:Nd,fragmentShader:Pd,transparent:!0,depthWrite:!1,depthTest:!1,blending:2}));v.position.set(0,0,0),r.add(v);let y={uProgress:{value:0},uIntensity:{value:0}},b=new pi(new xa(1,1),new Aa({uniforms:y,vertexShader:Nd,fragmentShader:Fd,transparent:!0,depthWrite:!1,depthTest:!1,blending:2}));b.position.set(0,0,0),r.add(b);let x=!1;new Su().load(`/models/hero.glb`,e=>{let t=e.scene,n=new cr().setFromObject(t),i=n.getCenter(new G);t.position.sub(i);let a=n.getBoundingSphere(new Nr).radius;p=Math.max(a*.0018,.012),t.traverse(e=>{if(e instanceof pa){let t=e.geometry.attributes.position,n=e.geometry.attributes.color;if(t&&n){let r=t.count,i=new Y,a={h:0,s:0,l:0},o=new Float32Array(r*3),s=new Float32Array(r*4);for(let e=0;e<r;e++){let r=t.getX(e),c=t.getY(e),l=t.getZ(e),u=Math.sqrt(r*r+c*c+l*l),d=Math.random()*2-1,f=Math.random()*Math.PI*2,p=Math.sqrt(1-d*d),m=.55+Math.random()*.75;if(o[e*3]=p*Math.cos(f)*m,o[e*3+1]=p*Math.sin(f)*(.65+Math.random()*.7),o[e*3+2]=d*m,s[e*4]=Math.random(),s[e*4+1]=Math.random(),s[e*4+2]=Math.random(),s[e*4+3]=Math.random(),i.setRGB(n.getX(e),n.getY(e),n.getZ(e)),i.getHSL(a),a.s=Math.min(a.s*1.1,1),i.setHSL(a.h,a.s,a.l),u>12){let e=Math.max(1-(u-12)/12,.12);i.r*=e,i.g*=e,i.b*=e}n.setXYZ(e,i.r,i.g,i.b)}n.needsUpdate=!0,e.geometry.setAttribute(`aDir`,new Er(o,3)),e.geometry.setAttribute(`aRand`,new Er(s,4))}let r=e.material;m=r,r.color=new Y(16777215),r.vertexColors=!0,r.map=f,r.size=p,r.sizeAttenuation=!0,r.transparent=!0,r.depthWrite=!1,r.blending=2,r.opacity=.85,r.needsUpdate=!0,e.geometry.computeBoundingSphere();let i=e.geometry.boundingSphere.center;r.onBeforeCompile=e=>{e.uniforms.uP=h,e.uniforms.uTime=g,e.uniforms.uCenter={value:i},e.vertexShader=`
              attribute vec3 aDir;
            ...
            `.replace(`#include <begin_vertex>`,`
              ...
              `)}}}),r.add(t),x=!0});let S=new G,C=new G(0,0,0),w=0,T=0,E=2,D=0,O=!1,k=performance.now(),A=0,j=``,M=document.documentElement;function ee(){let e=window.innerWidth/window.innerHeight;if(i.aspect=e,i.near=.1,i.far=1e3,e<1.4){let t=55*Math.PI/180,n=2*Math.atan(Math.tan(t/2)*1.4),r=2*Math.atan(Math.tan(n/2)/e);i.fov=Math.min(82,r*180/Math.PI)}else i.fov=55;i.updateProjectionMatrix()}ee();let te=()=>{o=a(),ee(),s.setSize(window.innerWidth,window.innerHeight),c.setSize(window.innerWidth,window.innerHeight),s.setPixelRatio(o?1:Math.min(window.devicePixelRatio,2))};window.addEventListener(`resize`,te);let ne=()=>{if(!O)return;let e=window.scrollY,t=Math.max(document.documentElement.scrollHeight-window.innerHeight,1);E=2+Math.min(Math.max(e/t,0),1)*5};window.addEventListener(`scroll`,ne,{passive:!0});let re=0,ie=0,ae=e=>{o||(re=(e.clientX/window.innerWidth-.5)*2,ie=(e.clientY/window.innerHeight-.5)*2)};window.addEventListener(`mousemove`,ae,{passive:!0});function oe(){let e=performance.now(),t=Math.min((e-k)/1e3,.1);k=e,w+=t*.12,g.value+=t;let n=Math.min(1,D*.75);h.value=n;function a(e,t,n){let r=Math.min(1,Math.max(0,(e-t)/(n-t)));return Math.sin(r*Math.PI)**2*(r>0&&r<1)}function l(e,t,n){let r=Math.min(1,Math.max(0,(n-e)/(t-e)));return r*r*(3-2*r)}let u=.5+.5*Math.sin(g.value*2.6),d=1-l(.28,.36,n),f=a(n,.3,.42),ee=a(n,.56,.68);_.uIntensity.value=d*(.45+.6*u+1.8*l(.05,.3,n))+a(n,.32,.4)*3+a(n,.58,.66)*1.8,_.uCore.value=d*1.4+f*2.2+ee*1.2;let te=1-a(n,.38,.56)*.7;_.uIntensity.value*=te,_.uCore.value*=te;let ae=3+12*l(.1,.34,n)+30*f;v.scale.setScalar(ae);let se=Math.max(l(.3,.56,n),l(.56,.84,n));y.uProgress.value=se,y.uIntensity.value=(f*2.2+ee*1.6)*(1-l(.9,1,n)),b.scale.setScalar(15+80*se);let N=1-l(.82,.98,n);v.visible=_.uIntensity.value*N>.002,_.uIntensity.value*=N;let ce=l(.65,.95,n).toFixed(4);if(ce!==j&&(M.style.setProperty(`--ui-fade`,ce),j=ce),!O&&x){let e=.167;if(D>.5&&D<=1.25)e=.35;else if(D>1.25){let t=1-(D-1.25)/.75;e=.12+.23*Math.max(t,0)}D+=t*e,D>=2&&(D=2,O=!0,ne()),T=D}else{let e=E-T;T+=e*Math.min(t*6,1)}let le=Rd.length-1,ue=Math.max(0,Math.min(T,le)),P=Math.floor(ue),de=Math.min(P+1,le),fe=ue-P,pe=Rd[P],me=Rd[de],he=zd(fe),ge=pe.angle+(me.angle-pe.angle)*he,_e=pe.radius+(me.radius-pe.radius)*he,ve=pe.height+(me.height-pe.height)*he,ye=ge+w;if(S.set(Math.sin(ye)*_e,ve,Math.cos(ye)*_e),C.set(0,0,0),m){let e=Math.min(ue/le,1),t=Math.max((e-.5)/.5,0),n=1-t*.45,r=1-t*.35;m.size=p*n*.35,m.opacity=1*r}let be=S.clone();o||(be.x+=re*.006,be.y+=-ie*.006),i.position.copy(be),i.lookAt(C),v.quaternion.copy(i.quaternion),b.quaternion.copy(i.quaternion),o?s.render(r,i):c.render(),A=requestAnimationFrame(oe)}return oe(),()=>{cancelAnimationFrame(A),window.removeEventListener(`resize`,te),window.removeEventListener(`scroll`,ne),window.removeEventListener(`mousemove`,ae),s.dispose(),n.removeChild(s.domElement)}},[e])}var $=i();function Vd(){let e=(0,Id.useRef)(null);return Bd(e),(0,$.jsx)(`div`,{ref:e,"aria-hidden":!0,className:`pointer-events-none fixed inset-0 z-0 [&>canvas]:h-full [&>canvas]:w-full`})}var Hd={title:`MAGNOVITE 2026 — A Cinematic Cosmic Unveiling`,description:`MAGNOVITE 2026, the 16th edition flagship fest of CHRIST (Deemed to be University), Kengeri Campus. 34+ national battlegrounds, ₹3L+ prizes and a live concert by Shaan Rahman.`,ogDescription:`A star explodes, the butterflies rise, the dust becomes a universe. Explore 34+ events, ₹3L+ prizes and the Shaan Rahman main stage.`},Ud={butterflyUrl:`/logos/magnovite-butterfly.png`,revealHeading:`MAGNOVITE`,revealSub:`2026`},Wd=[{icon:d,title:`Coding & AI`,items:`Code Relay · Reverse Coding · CTF Enigma · AI Sprints`},{icon:f,title:`Robotics & Tech`,items:`Robo Soccer · Drone Obstacle · RC Racing · Byte & Board`},{icon:r,title:`Management & Pitch`,items:`Best Manager · Spark Tank · Finance Pitch · Case Craft`},{icon:p,title:`Music & Vocal`,items:`Battle of the Bands · Acapella Showdown · Live Rhythms`},{icon:m,title:`Dance & Theater`,items:`Street Dance Battle · Theme Dance · Nukkad Natak Play`},{icon:e,title:`Gaming & Design`,items:`Argo Royale · Escape Room · CAD Design · Short Film`}],Gd=[[`34+`,`Events`],[`₹3L+`,`Prizes`]],Kd=[{image:`/images/Gallery/DJnight.jpg`,caption:`Night concert`},{image:`/images/Gallery/deadman.jpg`,caption:`Main stage, 2025`},{image:`/images/Gallery/StreetDance.jpg`,caption:`Street dance battle`},{image:`/images/Gallery/masalacoffeepremass.jpg`,caption:`Live performance`},{image:`/images/Gallery/brightcoffee.jpg`,caption:`MasalaCoffee`},{image:`/images/Gallery/FashionShow.jpg`,caption:`Fashion showcase`}],qd=`Magnovite 2026 · 16th Edition`,Jd={url:`/images/shaan-new-poster.jpg`,alt:`Music composer and singer Shaan Rahman performing live`};function Yd(){return{categories:(0,Id.useMemo)(()=>Wd,[]),gallery:(0,Id.useMemo)(()=>Kd,[]),hero:(0,Id.useMemo)(()=>Ud,[]),meta:(0,Id.useMemo)(()=>Hd,[]),stats:(0,Id.useMemo)(()=>Gd,[]),shaan:(0,Id.useMemo)(()=>Jd,[]),footer:(0,Id.useMemo)(()=>qd,[])}}function Xd(){let{categories:e,gallery:n,hero:r,stats:i,shaan:c}=Yd();return(0,$.jsxs)(`div`,{id:`top`,className:`relative bg-black`,children:[(0,$.jsx)(Vd,{}),(0,$.jsx)(`div`,{"aria-hidden":!0,className:`pointer-events-none fixed inset-0 z-30 bg-white transition-opacity duration-100`,style:{opacity:`calc(var(--flash) * 0.92)`}}),(0,$.jsx)(l,{}),(0,$.jsx)(`section`,{className:`relative z-10 flex h-screen flex-col items-center justify-center px-6 pointer-events-none`,children:(0,$.jsxs)(`div`,{className:`flex flex-col items-center gap-8 text-center mt-[5vh] pointer-events-auto`,style:{opacity:`var(--ui-fade, 0)`},children:[(0,$.jsxs)(`div`,{className:`flex flex-col items-center gap-5`,children:[(0,$.jsx)(`img`,{src:`/logos/magnovite-butterfly.png`,alt:`Magnovite Logo`,className:`h-12 w-auto opacity-90 sm:h-16`,style:{filter:`drop-shadow(0 0 10px rgba(255,255,255,0.15))`}}),(0,$.jsxs)(`h1`,{className:`font-display text-5xl font-bold tracking-widest text-white sm:text-7xl`,style:{textShadow:`0 0 30px rgba(0,0,0,0.8)`},children:[`MAGN`,(0,$.jsxs)(`span`,{className:`relative inline-block`,children:[`O`,(0,$.jsx)(`svg`,{className:`absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-4 h-4 sm:w-6 sm:h-6`,viewBox:`0 0 24 24`,fill:`white`,xmlns:`http://www.w3.org/2000/svg`,style:{filter:`drop-shadow(0 0 4px rgba(255,255,255,0.8))`},children:(0,$.jsx)(`path`,{d:`M12 0C12 11 13 12 24 12C13 12 12 13 12 24C12 13 11 12 0 12C11 12 12 11 12 0Z`})})]}),`VITE`]})]}),(0,$.jsx)(a,{}),(0,$.jsxs)(t,{to:`/events`,className:`glass-pill mt-2 inline-flex items-center gap-2 px-7 py-3.5 text-sm font-medium transition-all hover:scale-105`,children:[`Explore Events `,(0,$.jsx)(o,{className:`size-4`})]})]})}),(0,$.jsx)(`section`,{id:`about`,className:`relative z-10 px-5 py-20 sm:px-8`,children:(0,$.jsx)(`div`,{className:`mx-auto max-w-4xl`,children:(0,$.jsxs)(`div`,{className:`glass-panel p-6 sm:p-9`,children:[(0,$.jsx)(`p`,{className:`eyebrow`,children:`The 16th Edition`}),(0,$.jsx)(`p`,{className:`mt-5 text-lg leading-relaxed text-white/85 sm:text-[1.35rem] sm:leading-[1.55]`,children:`MAGNOVITE is the annual flagship fest of CHRIST (Deemed To Be University), Kengeri Campus — an enigmatic nexus of creativity and collaboration, bringing healthy competition and positive connections. Sixteen editions in, its unfading charm returns.`}),(0,$.jsxs)(`div`,{className:`mt-7 flex flex-wrap items-center justify-between gap-4`,children:[(0,$.jsx)(`div`,{className:`flex flex-wrap gap-2.5`,children:[`16th Edition`,`Kengeri Campus`,`34+ Events`].map(e=>(0,$.jsx)(`span`,{className:`glass-pill px-4 py-2 text-xs tracking-wide`,children:e},e))}),(0,$.jsxs)(t,{to:`/about`,className:`inline-flex items-center gap-1.5 text-xs font-semibold text-indigo-400 transition-colors hover:text-indigo-300`,children:[`Learn More & Meet The Team `,(0,$.jsx)(o,{className:`size-3.5`})]})]}),(0,$.jsxs)(`div`,{className:`relative mt-8 aspect-video overflow-hidden rounded-2xl border border-white/10 bg-black/60`,children:[(0,$.jsx)(`div`,{className:`absolute inset-0 grid place-items-center`,children:(0,$.jsx)(`button`,{"aria-label":`Play the Magnovite 2026 teaser`,className:`grid size-14 place-items-center rounded-full bg-white/90 text-black transition-transform hover:scale-105`,children:(0,$.jsx)(s,{className:`size-5 translate-x-[1px]`})})}),(0,$.jsx)(`div`,{className:`absolute inset-x-0 bottom-0 p-4 text-xs tracking-[0.28em] text-white/50 uppercase`,children:`Magnovite 2026 · Teaser`})]})]})})}),(0,$.jsx)(`section`,{id:`mainstage`,className:`relative z-10 px-5 py-20 sm:px-8`,children:(0,$.jsxs)(`div`,{className:`glass-panel mx-auto grid max-w-5xl gap-8 p-6 sm:p-8 lg:grid-cols-[minmax(0,0.85fr)_minmax(0,1.15fr)]`,children:[(0,$.jsxs)(`div`,{className:`relative overflow-hidden rounded-2xl border border-white/10`,children:[(0,$.jsx)(`img`,{src:c.url,alt:c.alt,loading:`lazy`,className:`h-full w-full object-cover`}),(0,$.jsx)(`span`,{className:`glass-pill absolute top-4 left-4 px-3.5 py-1.5 text-[0.65rem] tracking-[0.22em] uppercase`,children:`Live Concert · Sep 16`})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`p`,{className:`eyebrow`,children:`Main Stage Showcase`}),(0,$.jsx)(`h2`,{className:`mt-3 text-2xl font-semibold sm:text-3xl`,children:`Welcoming Shaan Rahman to Magnovite 2026`}),(0,$.jsxs)(`div`,{className:`mt-5 space-y-4 text-[0.92rem] leading-relaxed text-white/75`,children:[(0,$.jsx)(`p`,{children:`Get ready to experience the magic of one of the most celebrated music composers and singers in the industry today! Shaan Rahman is the creative force behind some of South India's biggest hits, known for effortlessly blending massive dance tracks with deep, soulful melodies.`}),(0,$.jsxs)(`p`,{children:[`He has quite literally shaped the soundtrack of a generation — from the timeless romance of `,(0,$.jsx)(`em`,{children:`Thattathin Marayathu`}),` and `,(0,$.jsx)(`em`,{children:`Jacobinte Swargarajyam`}),` to the high-energy beats of `,(0,$.jsx)(`em`,{children:`Godha`}),`. Whether you are getting hyped to global dance anthem `,(0,$.jsx)(`strong`,{className:`text-white`,children:`"Jimikki Kammal"`}),` or singing your heart out to `,(0,$.jsx)(`strong`,{className:`text-white`,children:`"Aaro Nenjil"`}),` and`,` `,(0,$.jsx)(`strong`,{className:`text-white`,children:`"Manikya Malaraya Poovi"`}),`, his versatile discography has something for every single mood.`]}),(0,$.jsx)(`p`,{children:`His infectious energy and incredible vocal talent make his live shows an absolute must-see. Bring your friends, warm up those vocal cords, and get ready to groove to his chart-topping hits live on the main stage!`})]}),(0,$.jsxs)(`div`,{className:`mt-6 flex flex-wrap gap-2.5`,children:[(0,$.jsx)(`span`,{className:`glass-pill px-4 py-2 text-xs`,children:`Live Performance`}),(0,$.jsx)(`span`,{className:`glass-pill px-4 py-2 text-xs`,children:`Main Stage`})]})]})]})}),(0,$.jsx)(`section`,{id:`events`,className:`relative z-10 px-5 py-20 sm:px-8`,children:(0,$.jsxs)(`div`,{className:`glass-panel mx-auto max-w-5xl p-6 sm:p-8`,children:[(0,$.jsxs)(`div`,{className:`flex flex-wrap items-end justify-between gap-5`,children:[(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`p`,{className:`eyebrow text-accent`,children:`Flagship Competitions & Challenges`}),(0,$.jsx)(`h2`,{className:`mt-2 text-3xl font-semibold sm:text-4xl`,children:`34+ National Battlegrounds`})]}),(0,$.jsx)(`div`,{className:`flex gap-2.5`,children:i.map(([e,t])=>(0,$.jsxs)(`div`,{className:`glass-pill px-5 py-2.5 text-center`,children:[(0,$.jsx)(`div`,{className:`font-display text-lg font-semibold`,children:e}),(0,$.jsx)(`div`,{className:`text-[0.52rem] tracking-[0.3em] text-muted-foreground uppercase`,children:t})]},t))})]}),(0,$.jsx)(`div`,{className:`mt-8 grid gap-3.5 sm:grid-cols-2 lg:grid-cols-3`,children:e.map(({icon:e,title:t,items:n})=>(0,$.jsxs)(`div`,{className:`rounded-2xl border border-white/8 bg-white/[0.025] p-4.5 transition-colors hover:border-white/15 hover:bg-white/[0.05]`,children:[(0,$.jsx)(`span`,{className:`grid size-9 place-items-center rounded-xl border border-white/10 bg-white/5`,children:(0,$.jsx)(e,{className:`size-4`})}),(0,$.jsx)(`h3`,{className:`mt-4 text-base font-semibold`,children:t}),(0,$.jsx)(`p`,{className:`mt-1.5 text-xs leading-relaxed text-muted-foreground`,children:n})]},t))}),(0,$.jsxs)(`div`,{className:`mt-8 flex flex-wrap items-center justify-between gap-5 border-t border-white/8 pt-6`,children:[(0,$.jsx)(`p`,{className:`max-w-md text-xs text-muted-foreground`,children:`Technical, Cultural & Management flagship events hosted across CHRIST University Kengeri Campus.`}),(0,$.jsxs)(t,{to:`/events`,className:`inline-flex items-center gap-2 rounded-full bg-white px-5 py-3 text-xs font-semibold text-black transition-transform hover:scale-[1.02]`,children:[`Explore All 34+ Events `,(0,$.jsx)(o,{className:`size-4`})]})]})]})}),(0,$.jsx)(`section`,{id:`gallery`,className:`relative z-10 px-5 py-20 sm:px-8`,children:(0,$.jsxs)(`div`,{className:`mx-auto max-w-5xl`,children:[(0,$.jsxs)(`div`,{className:`flex items-end justify-between`,children:[(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`p`,{className:`eyebrow`,children:`Gallery`}),(0,$.jsx)(`h2`,{className:`mt-2 text-2xl font-semibold sm:text-3xl`,children:`Fragments from the fifteenth edition`})]}),(0,$.jsxs)(t,{to:`/gallery`,className:`glass-pill hidden items-center gap-2 px-4 py-2 text-xs font-semibold uppercase tracking-wider sm:inline-flex`,children:[`View Full Gallery `,(0,$.jsx)(o,{className:`size-3.5`})]})]}),(0,$.jsx)(`div`,{className:`mt-8 grid gap-3.5 sm:grid-cols-3`,children:n.map(({image:e,caption:t},n)=>(0,$.jsxs)(`div`,{className:`glass-panel relative aspect-[4/3] overflow-hidden`,children:[(0,$.jsx)(`img`,{src:e,alt:t,className:`absolute inset-0 h-full w-full object-cover`,loading:`lazy`}),(0,$.jsx)(`div`,{className:`absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent`}),(0,$.jsx)(`span`,{className:`absolute bottom-4 left-4 text-[0.65rem] tracking-[0.22em] text-white/70 uppercase`,children:t})]},t))})]})}),(0,$.jsxs)(`section`,{className:`relative z-10 flex min-h-[80vh] flex-col items-center justify-center px-6 text-center`,children:[(0,$.jsx)(`img`,{src:r.butterflyUrl,alt:``,className:`h-10 w-auto opacity-70`}),(0,$.jsx)(`h2`,{className:`mt-8 max-w-3xl text-4xl leading-tight font-semibold sm:text-6xl`,children:`We're excited to see you there.`}),(0,$.jsx)(`p`,{className:`mt-5 text-sm tracking-[0.28em] text-white/90 uppercase font-medium`,style:{textShadow:`0 2px 10px rgba(0,0,0,0.8)`},children:`CHRIST University · Kengeri Campus`})]}),(0,$.jsx)(`footer`,{className:`relative z-10 mt-10 glass-panel rounded-none border-x-0 border-b-0`,style:{background:`linear-gradient(160deg, oklch(1 0 0 / 4%) 0%, oklch(1 0 0 / 1%) 38%, oklch(0 0 0 / 15%) 100%), oklch(0.07 0.004 260 / 30%)`},children:(0,$.jsxs)(`div`,{className:`mx-auto max-w-6xl px-6 py-10 sm:px-8 sm:py-12 flex flex-col gap-5`,children:[(0,$.jsxs)(`div`,{className:`footer-brand`,style:{marginBottom:`2.5rem`},children:[(0,$.jsx)(`img`,{src:`/logos/christwhite.png`,alt:`CHRIST University`,className:`footer-logo footer-logo--christ`,style:{height:`50px`,opacity:.9}}),(0,$.jsx)(`div`,{className:`footer-divider`,style:{height:`40px`,margin:`0 0.5rem`}}),(0,$.jsx)(`img`,{src:`/logos/magnovite.png`,alt:`Magnovite '26`,className:`footer-logo`,style:{height:`38px`,opacity:.9}})]}),(0,$.jsxs)(`div`,{className:`footer-columns`,style:{gridTemplateColumns:`1fr 1fr`,gap:`4rem`},children:[(0,$.jsx)(`div`,{className:`footer-col`,children:(0,$.jsx)(`p`,{style:{fontSize:`0.9rem`,lineHeight:1.7,color:`rgba(255, 255, 255, 0.65)`,maxWidth:`90%`},children:`Christ University, Kengeri Campus offers a blend of traditional and world-class facilities, including department-specific buildings, libraries, research facilities, and residences, amidst the city's greenery.`})}),(0,$.jsxs)(`div`,{className:`footer-col`,children:[(0,$.jsx)(`p`,{style:{fontSize:`0.9rem`,lineHeight:1.7,color:`rgba(255, 255, 255, 0.65)`},children:`MAGNOVITE, the 16th edition of CHRIST University's flagship fest, fosters creativity, collaboration, healthy competition, and positive connections among participants.`}),(0,$.jsxs)(`div`,{className:`footer-social`,style:{marginTop:`1rem`},children:[(0,$.jsx)(`a`,{href:`https://www.linkedin.com/company/christ-university-faculty-of-engineering/?originalSubdomain=in`,target:`_blank`,rel:`noopener noreferrer`,className:`social-link`,"aria-label":`LinkedIn`,children:(0,$.jsx)(`svg`,{className:`social-icon`,width:`18`,height:`18`,viewBox:`0 0 24 24`,fill:`none`,children:(0,$.jsx)(`path`,{d:`M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.227 0 22.222 0h.003z`,fill:`currentColor`})})}),(0,$.jsx)(`a`,{href:`https://www.instagram.com/magnovite.kengeri/`,target:`_blank`,rel:`noopener noreferrer`,className:`social-link`,"aria-label":`Instagram`,children:(0,$.jsx)(`svg`,{className:`social-icon`,width:`18`,height:`18`,viewBox:`0 0 24 24`,fill:`none`,children:(0,$.jsx)(`path`,{d:`M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618-6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.204-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.163 6.162 6.163 6.162-2.759 6.162-6.163c0-3.403-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4 0-2.209 1.791-4 4-4s4 1.79 4 4c0 2.21-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.44z`,fill:`currentColor`})})})]})]})]})]})})]})}var Zd=Xd;export{Zd as component};